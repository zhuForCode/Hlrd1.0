package com.juhua.hangfen.shaoxingrd.widget;

/**
 * Created by JiaJin Kuai on 2017/3/31.
 */
...
public class CounterFab extends FloatingActionButton {
    ...
    private static final int MASK_COLOR = Color.parseColor("#FFE62F2F"); // Translucent black as mask color
