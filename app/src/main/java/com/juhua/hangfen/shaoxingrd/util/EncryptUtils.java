...
import com.juhua.hangfen.shaoxingrd.tools.AesCbcWithIntegrity;
...
public final class EncryptUtils {
    ...
    public static String base64DecodeString(final byte[] input) {
    ...
    public static String encrptString(String text){
        try {
            AesCbcWithIntegrity.SecretKeys keys = AesCbcWithIntegrity.keys(Constants.AES_KEY);
    ...
    public static String decryptString(String text){
        try {
            AesCbcWithIntegrity.SecretKeys keys = AesCbcWithIntegrity.keys(Constants.AES_KEY);
            AesCbcWithIntegrity.CipherTextIvMac cipherTextIvMacA  = new AesCbcWithIntegrity.CipherTextIvMac(text);
            return AesCbcWithIntegrity.decryptString(cipherTextIvMacA, keys);
        }catch (Exception e){
            return null;
        }
    }
