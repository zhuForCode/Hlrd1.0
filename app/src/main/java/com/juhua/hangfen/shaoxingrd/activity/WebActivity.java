...
import com.juhua.hangfen.shaoxingrd.enums.LoadStateEnum;
import com.juhua.hangfen.shaoxingrd.model.Nav;
...
import com.juhua.hangfen.shaoxingrd.util.DownloadUtil;
import com.juhua.hangfen.shaoxingrd.util.GsonUtil;
import com.juhua.hangfen.shaoxingrd.util.ToastUtils;
import com.juhua.hangfen.shaoxingrd.util.ViewUtils;

import java.io.File;
import java.net.URLEncoder;

import static com.juhua.hangfen.shaoxingrd.constants.Constants.RESULT_CONTACT_CONFIRM;
...
public class WebActivity extends BaseActivity {
    ...
    public  class MAndroid{
        ...
        public void toDownloadFile(final String urlD){
            progressFile = new ProgressDialog(AppManager.getAppManager().currentActivity());    //进度条，在下载的时候实时更新进度，提高用户友好度
